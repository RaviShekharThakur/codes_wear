        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code with Codes Wear.com</h1>
              <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear what you want. Whenever you want. As a developer. Why dont you wear the code?</p>
            </div>
